...
const REMINDER_MESSAGES = [
  ...
  `والله أخي ما كنخسرك 😤 — ناس كانو زيك مترددين، دبا كيربحو كل نهار. الكود *999BOT* في Melbet وأنا معاك`,
  `أخي جرب غير مرة وحدة 🎯 — إلا ما عجبكش ما عليك والو. غير سجل في Melbet بالكود *999BOT*`,
  `كل يوم كيفوت عليك فلوس 💸 — السكريبت كيخدم بصح أخي. دير حساب جديد في Melbet بالكود *999BOT*`,
  `أخي 🤫 هاد السكريبت ما بغيتش ينتشر بزاف — بس أنا نقدر نعطيك إياه. غير سجل بالكود *999BOT* في Melbet`,
  `راك ساعة ونص ما ردتيش 😅 — إلا عندك سؤال سولني، وإلا سجل مباشرة في Melbet بالكود *999BOT*`,
  `أخي ببساطة — سكريبت + حساب جديد في Melbet = فلوس 💰 الكود *999BOT* وبدا معانا`,
  `ناس من نفس المدينة ديالك كيستعملو السكريبت 🏆 — أنت شنو كتسنا؟ سجل بالكود *999BOT* في Melbet`,
  `أخي الحياة قصيرة 😂 — سجل في Melbet بالكود *999BOT* وشوف بعينيك كيفاش كيخدم السكريبت`,
  `خبرك صغير 😄 — واحد من صحابي دار *310 درهم* في ساعة مع السكريبت. سجل بالكود *999BOT* في Melbet`,
  `أخي إلا عندك شك ڤيني نحكيو 🙏 — السكريبت ما فيه حتى حاجة تتقلق منها. الكود *999BOT* في Melbet`,
  `🔔 تذكير — السكريبت بتاعنا مازال شغال بنسبة عالية الأسبوع هذا. سجل دبا في Melbet بالكود *999BOT*`,
  `أخي انتبه 🍎 — مرة كل شهر كندير هاد العرض، مازلت وقت. سجل في Melbet بالكود *999BOT* وأنا نبعث ليك السكريبت`,
  `راك تقرا هادشي 😏 — إذن أنت مهتم! يلاه أخي سجل في Melbet بالكود *999BOT* وبدا تربح`,
  `أخي هاد السكريبت مش للكل 👊 — أنا كنعطيه غير للناس اللي كيدخلو بالكود *999BOT* في Melbet. أنت فين؟`,
  `🎰 اليوم الحظ مزيان — أخي سجل دبا في Melbet بالكود *999BOT* وجرب السكريبت، أنا كنضمن ليك المساعدة`,
  `واش سبق ليك تربح فلوس من التطبيقات أخي؟ 🤔 لأ؟ يلاه هاد السكريبت هو البداية — سجل في Melbet بالكود *999BOT*`,
  `شنو اللي كيخليك متردد أخي؟ 😕 الخوف من الخسارة؟ ما كاينش حساب ولا شي؟ ڤيلي وأنا نساعدك`,
  `واش تعرف أخي بشحال كيربحو الناس مع السكريبت في يوم وحد؟ 💰 سولني وأنا نخبرك — بعدها سجل بالكود *999BOT*`,
  `أخي واش تيبا ليك السكريبت غالي؟ 🤨 خبرك — هو مجاني بالكامل! غير سجل في Melbet بالكود *999BOT*`,
  `واش سمعت بالسكريبت ديال تفاحة الحظ من قبل؟ 🍎 إلا لا، أنا نشرح ليك كل شي — سولني`,
  `أخي واش عندك تطبيق Melbet منزل؟ 📱 إلا لا، ابدا من هناك — حمله من melbet.com وسجل بالكود *999BOT*`,
  `شنو كتسنا بالضبط أخي؟ ⏳ إلا فيه شي ما فهمتيش، ڤيلي دبا وأنا نوضح ليك`,
  `واش تعرف أخي فين كتلقى الـ ID ديالك في Melbet بعد التسجيل؟ 📋 سجل وأنا نرشدك خطوة بخطوة — الكود *999BOT*`,
  `أخي واش كتفكر التوقعات ديال السكريبت كتجي عشوائية؟ 😂 لا والله — هاد السكريبت عنده نظام. سجل بالكود *999BOT* وشوف`,
  `شنو اللي تعلمتيه من المراهنات حتى دبا أخي؟ 🎯 إلا ما ربحتيش بزاف، السكريبت هو اللي كان ناقصك — الكود *999BOT* في Melbet`,
];
