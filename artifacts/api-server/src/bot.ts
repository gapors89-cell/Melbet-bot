...
const MELBET_VARIANTS = [
  `واش عندك حساب جديد في Melbet؟ 🤔\n\nالسكريبت مايشتغلش غير مع حساب جديد، استعمل الكود *999BOT* عند التسجيل وغادي يخدم معك مزيان ✅`,
  `صافي تنجم تستعمل السكريبت، غير خاصك تدير حساب جديد في Melbet بالكود *999BOT* 🎯\n\nالحساب القديم مايتشغلش معاه من الأصل`,
  `آه الشي الوحيد اللي خاصك تعرفو — السكريبت كيطلب حساب جديد في Melbet\n\n📌 الكود: *999BOT*\n\nبلا هاد الكود ما غادي يتشغل صح ⚠️`,
  `🔑 باش تلقى التوقعات الصحيحة:\n\nسجل حساب جديد في Melbet واكتب الكود *999BOT*\n\nالحساب القديم مايقدرش يتشغل معاه، هذا مهم ✅`,
  `فالحقيقة الشرط الوحيد للسكريبت — حساب جديد في Melbet بالكود *999BOT* 🎯\n\nبلا هذا ما غادي يعطيك التوقعات الصحيحة ⚠️`,
];
